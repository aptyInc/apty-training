...
const foodSound = new Audio('./../html/sanke-game-accets/food.mp3');
const gameOverSound = new Audio('./../html/sanke-game-accets/gameover.mp3');
const moveSound = new Audio('./../html/sanke-game-accets/move.mp3');
const musicSound = new Audio('./../html/sanke-game-accets/music.mp3');
